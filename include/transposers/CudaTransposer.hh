...
protected:
    ...
    inline int csr2csc(int m, int n, int nnz, int* csrRowPtr, int* csrColIdx, float* csrVal, int* cscColPtr, int* cscRowIdx, float* cscVal) {
        ...
        int ret = csr2csc_gpumemory(
            m, n, nnz, 
            csrRowPtr_dev, csrColIdx_dev, csrVal_dev, 
            cscColPtr_dev, cscRowIdx_dev, cscVal_dev,
    ...
    virtual int csr2csc_gpumemory(
        ...
        int* cscColPtr_host, int* cscRowIdx_host, float* cscVal_host) = 0;
